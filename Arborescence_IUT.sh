...
# Main (Code executer) #
folder=$(TERM=ansi whiptail --inputbox "Veuillez entrer le chemin du répertoire d'instalation de l'arborescence de l'IUT (un repertoire fils de '/home/$USER' sinon la permission ne sera pas accorder pour la création de l'arborescence)" 20 80 /home/$USER 3>&1 1>&2 2>&3) && {
